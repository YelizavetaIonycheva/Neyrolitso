...
public class AdvancedSettingsSubScreenFragment extends PreferenceFragmentCompat {
    ...
    private PreferenceScreen createPrefScreenNextKey() {
        ...
        Preference pref_key_n_name_complected = new Preference(requireContext());
        pref_key_n_name_complected.setKey(getString(R.string.pref_key_n_name_komplect_key));
        pref_key_n_name_complected.setTitle(R.string.key_name_komplect_title);
        ...
        Preference pref_key_n_num_complected = new Preference(requireContext());
        pref_key_n_num_complected.setKey(getString(R.string.pref_key_n_num_komplect_key));
        pref_key_n_num_complected.setTitle(R.string.key_num_komplect_title);
        ...
        preferenceCategory.addPreference(pref_key_n_name_complected);
        preferenceCategory.addPreference(pref_key_n_num_serial);
        preferenceCategory.addPreference(pref_key_n_num_complected);
